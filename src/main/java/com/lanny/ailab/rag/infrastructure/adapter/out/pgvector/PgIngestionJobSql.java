...
final class PgIngestionJobSql {
    ...
    static final String JOB_COLUMNS = """
            ...
            metadata_owner, metadata_classification, source_type, source_uri, status, request_version, processing_lease_version,
            chunks_indexed, error_message,
    ...
    private static String aliasedColumns(String alias) {
        return """
                ...
                %s.request_version AS request_version, %s.processing_lease_version AS processing_lease_version,
                %s.chunks_indexed AS chunks_indexed,
