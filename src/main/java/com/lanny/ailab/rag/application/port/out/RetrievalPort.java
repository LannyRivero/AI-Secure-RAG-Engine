 ...
 *
 * <p>
 * Implementations may use different retrieval strategies — for example,
...
public interface RetrievalPort {
    ...
    /**
     * Retrieves the most relevant chunks for the given query within a specific
     * tenant.
     *
     * @param query    the user's natural language query
     * @param tenantId the owning tenant; restricts results to that tenant's data
     * @param topK     maximum number of chunks to return
     * @param filters  optional metadata constraints applied in addition to tenant
     *                 isolation
     * @return a list of matching {@link DocumentChunk}s ordered by relevance
     *         descending,
