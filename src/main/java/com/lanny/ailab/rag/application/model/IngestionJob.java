 ...
 * @param metadata               structured business metadata to copy into
 *                               indexed
 *                               chunks
 * @param sourceType             connector kind used to resolve the queued text
 * @param sourceUri              original source locator when the content was
 *                               fetched
 *                               remotely
 * @param status                 persisted lifecycle status
 * @param requestVersion         monotonically increasing version for stale-work
 *                               detection
 * @param processingLeaseVersion monotonically increasing claim lease guarding
 *                               concurrent stale reclaims of the same request
 *                               version
 * @param chunksIndexed          final indexed chunk count when completed,
 *                               otherwise
 *                               zero
 ...
 * @param startedAt              processing start instant for the active
 *                               attempt, or
 *                               {@code null}
